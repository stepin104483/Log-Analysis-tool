...
def run_band_analysis(input_files, target_mcc, selected_kb, session_id):
    ...
    try:
        # Get the DeviceSWAnalyzer directory (parent of src/)
        ...
        band_combos_dir = os.path.dirname(src_dir)  # DeviceSWAnalyzer/
        ...
        # Import using package path from DeviceSWAnalyzer/
